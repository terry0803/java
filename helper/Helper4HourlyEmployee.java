...
public class Helper4HourlyEmployee extends Helper4SuperEmployeeBase1 {
	        ...
	        if (streamType_MenuOption == FileStreamType_MenuOption.STANDARD_BASED) {
	            while (inputT.hasNext()) { // while there is more to read
	                ...
	                record = new HourlyEmployee(inputT.next(), inputT.next(), inputT.next(), true,
	                        inputT.nextDouble(), inputT.nextDouble(), inputT.nextDouble(), _maxHoursPerWeek,
	                        minRateOfExtraHours, maxRateOfExtraHours, _normalHoursWorked);
