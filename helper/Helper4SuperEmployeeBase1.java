...
import org.jfree.chart3d.fx.demo.PieChart3DFXDemo4PayableSystem;
...
import Lin.library.filestream.FileChoosing4WriteOrRead_27Oct20;
...
public class Helper4SuperEmployeeBase1 {
	...
	public static FileChoosing4WriteOrRead_27Oct20 fileChoosing4WriteOrRead;public FileChoosing4WriteOrRead_20Dec23_extends FileChoosing4WriteOrRead_27Oct20;
...
public void enableProfileTextBoxes(boolean isEnable) {
	...
	public void readFile_EmployeeAccount() throws ClassNotFoundException, IOException, ArrayIndexOutOfBoundsException {
		...
		if (streamType_MenuOption != null) {
			 ...
			 */
			fileChoosing4WriteOrRead = new FileChoosing4WriteOrRead_27Dec20_extends(false, true,
...
//    	                                  "txtArea", JOptionPane.INFORMATION_MESSAGE);
	...
	public void runPieChart3DFX() {
		PieChart3DFXDemo4PayableSystem.categories = new String[3];
		PieChart3DFXDemo4PayableSystem.categories = Stream.of(
		...
		PieChart3DFXDemo4PayableSystem.values4Categories = new double[PieChart3DFXDemo4PayableSystem.categories.length];

		PieChart3DFXDemo4PayableSystem.values4Categories[0] = frameEmployee.employeeBook.levelsV[0];
		PieChart3DFXDemo4PayableSystem.values4Categories[1] = frameEmployee.employeeBook.levelsV[1];
		PieChart3DFXDemo4PayableSystem.values4Categories[2] = frameEmployee.employeeBook.levelsV[2];

		PieChart3DFXDemo4PayableSystem.title2Display = "Wage Distribution";
		//PieChart3DFXDemo4PayableSystem.launchMore(PieChart3DFXDemo4PayableSystem.class);
